...
var LegalCompliancePage = function () {
    return (<main className="min-h-screen bg-slate-50 flex flex-col">
            <SEO_1.default title="Yasal Mevzuat ve Hukuki Uygunluk - AvukatAğı" description="AvukatAğı'nın Avukatlık Kanunu'na uygunluğu, tevkil yetkisi ve komisyonculuk yasağına uyumu hakkında detaylı bilgilendirme." keywords="avukatlık kanunu, tevkil yetkisi, komisyonculuk yasağı, avukat ağı yasal mı, hukuki uygunluk"/>
                        ...
                        <header className="bg-slate-900 px-8 py-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex justify-center mb-6">
                                <div className="bg-white/10 p-4 rounded-full backdrop-blur-sm">
                                    <lucide_react_1.Scale className="h-12 w-12 text-primary-400"/>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                                <h4 className="font-bold text-blue-800 mb-2 flex items-center"><lucide_react_1.ShieldCheck className="h-4 w-4 mr-2"/> Tevkil Eden</h4>
                                                <p className="text-sm text-blue-700">Müvekkiline karşı sorumluluğunu sürdürür.</p>
                                            </div>
                                            <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                                                <h4 className="font-bold text-green-800 mb-2 flex items-center"><lucide_react_1.CheckCircle className="h-4 w-4 mr-2"/> Tevkil Edilen</h4>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-slate-50 p-6 rounded-xl mb-6">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-3">
                                                <div className="flex items-center text-slate-600"><lucide_react_1.AlertCircle className="h-4 w-4 text-red-500 mr-2"/> Avukatlara iş sağlamaz</div>
                                                <div className="flex items-center text-slate-600"><lucide_react_1.AlertCircle className="h-4 w-4 text-red-500 mr-2"/> Müvekkil yönlendirme yapmaz</div>
                                                <div className="flex items-center text-slate-600"><lucide_react_1.AlertCircle className="h-4 w-4 text-red-500 mr-2"/> Ücret karşılığı dava devri sağlamaz</div>
                                                <div className="flex items-center text-slate-600"><lucide_react_1.AlertCircle className="h-4 w-4 text-red-500 mr-2"/> Aracı veya komisyoncu konumunda değildir</div>
                                            </div>
                                        </div>
                                        <p className="text-slate-600 mb-4">
        ...
        ].map(function (item, i) { return (<li key={i} className="flex items-center bg-white border border-slate-200 p-3 rounded-lg text-sm text-slate-700 shadow-sm">
                                                    <lucide_react_1.CheckCircle className="h-4 w-4 text-green-500 mr-2 flex-shrink-0"/> {item}
                                                </li>); })}
                                        </ul>
                                        <p className="text-slate-600">
        ...
        ].map(function (item, i) { return (<li key={i} className="flex items-start text-slate-700">
                                                        <lucide_react_1.CheckCircle className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5"/>
                                                        <span>{item}</span>
                                                    </li>); })}
                                            </ul>
                                        </div>
...
exports.default = LegalCompliancePage;
