...
var TermsOfUse = function () {
    return (<div className="max-w-4xl mx-auto px-4 py-12">
            <SEO_1.default title="Kullanıcı Sözleşmesi - AvukatAğı" description="AvukatAğı Üyelik ve Kullanıcı Sözleşmesi. Platform kullanım koşulları, haklar ve yükümlülükler."/>
