            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto items-start">
                ...
                <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition duration-300 relative z-0">
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="flex items-center text-slate-400"><X className="h-5 w-5 mr-3 text-slate-300" /> Acil İlan Oluşturma</li>
                    </ul>
                ...
                <div className="bg-white p-8 rounded-2xl border border-amber-200 shadow-xl relative z-10 transform md:-translate-y-4">
                    ...
                    <div className="flex items-baseline mt-4">
                        <p className="text-5xl font-bold text-amber-600">₺249</p>
                        <p className="text-slate-500 ml-2">/ay</p>
                    </div>
                    <p className="text-slate-500 mt-2">Aktif çalışmak için ideal</p>
                    ...
                    {user.membershipType === 'premium' ? (
                        ...
                        <button
                            onClick={() => handleSelectPlan('premium', 249, 'monthly')}
                ...
                <div className="bg-slate-900 p-8 rounded-2xl border border-indigo-500/30 shadow-2xl relative z-10 text-white">
                    ...
                    <div className="flex items-baseline mt-4">
                        <p className="text-5xl font-bold text-indigo-400">₺499</p>
                        <p className="text-slate-400 ml-2">/ay</p>
                    </div>
                    <p className="text-slate-400 mt-2">Maksimum görünürlük ve güç</p>
                    ...
                    <ul className="space-y-5">
                        ...
                        <li className="flex items-center text-slate-200 font-medium"><CheckCircle className="h-5 w-5 text-indigo-400 mr-3" /> Tüm Şehirlerde Adliye Seçimi</li>
                        <li className="flex items-center text-slate-200 font-medium"><CheckCircle className="h-5 w-5 text-indigo-400 mr-3" /> Özel Müşteri Temsilcisi</li>
                    </ul>
                    ...
                    {user.membershipType === 'premium_plus' ? (
                        ...
                        <button
                            onClick={() => handleSelectPlan('premium_plus', 499, 'monthly')}
