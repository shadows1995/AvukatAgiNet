                     ...
                     <div className="ml-4 flex-1">
                        <div className="flex justify-between items-start">
                           ...
                           <span className="text-xs text-white bg-purple-500 px-2 py-0.5 rounded font-medium">
                             {job.status === 'in_progress' ? 'Görev Atandı' : job.status === 'completed' ? 'Tamamlandı' : 'Yeni İlan'}
                           </span>
                        </div>
        ...
        <div className="bg-white rounded-xl p-8 border border-slate-200 text-center">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                 ...
                 <p className="text-xs text-slate-500 mt-1">Detayları girin ve ilanı yayınlayın.</p>
              </div>
              <div>
