...
var PrivacyPolicy = function () {
    return (<div className="max-w-4xl mx-auto px-4 py-12">
            <SEO_1.default title="Gizlilik Politikası ve KVKK Aydınlatma Metni - AvukatAğı" description="AvukatAğı Gizlilik Politikası ve Kişisel Verilerin Korunması Kanunu (KVKK) kapsamında aydınlatma metni."/>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
                <div className="flex items-center gap-4 mb-8">
                    <div className="p-3 bg-green-100 rounded-xl">
                        <lucide_react_1.ShieldCheck className="w-8 h-8 text-green-600"/>
                    </div>
