  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <SEO
        ...
        description="Duruşma, dosya inceleme ve haciz işlemleri için güvenilir avukatlara işlerinizi tevkil edin. Tevkil platformuna katılın."
      />
      {/* Hero Section */}
      {/* Hero Section */}
      ...
      const { data, error } = await supabase.auth.signUp({
        ...
        options: {
          data: {
            ...
            premium_since: isPromoActive ? now.getTime() : null,
            premium_until: isPromoActive ? premiumUntilDate.getTime() : null,
