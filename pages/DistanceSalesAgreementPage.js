...
var DistanceSalesAgreementPage = function () {
    return (<div className="max-w-4xl mx-auto px-4 py-12">
            <SEO_1.default title="Mesafeli Satış Sözleşmesi - AvukatAğı" description="AvukatAğı Mesafeli Satış Sözleşmesi ve Ön Bilgilendirme Formu."/>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
                <div className="flex items-center gap-4 mb-8">
                    <div className="p-3 bg-primary-100 rounded-xl">
                        <lucide_react_1.FileText className="w-8 h-8 text-primary-600"/>
                    </div>
...
exports.default = DistanceSalesAgreementPage;
