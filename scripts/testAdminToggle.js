...
var supabaseAnonKey = process.env.VITE_SUPABASE_ANON_KEY; // Use Anon key to simulate frontend
...
function testToggle() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, user, loginError, _b, data, error;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _a = _c.sent(), user = _a.data.user, loginError = _a.error;
                    if (loginError || !user) {
