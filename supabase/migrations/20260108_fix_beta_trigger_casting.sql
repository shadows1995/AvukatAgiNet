-- FIX: Enable Beta Premium auto-assignment in trigger with correct casting
-- This migration updates the trigger to capture is_premium and cast timestamps correctly.
...
begin
  ...
  values (
    ...
    to_timestamp((new.raw_user_meta_data->>'premium_until')::bigint / 1000.0), -- Convert ms to seconds
    to_timestamp((new.raw_user_meta_data->>'premium_since')::bigint / 1000.0)  -- Convert ms to seconds
  )
